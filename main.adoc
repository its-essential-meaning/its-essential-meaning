...
:identifier: uuid:295de039-7a87-4965-8ca9-7b2461f76f44
:imagesdir: assets/photos/92dpi-ebook-sRGB
:includes: manuscript/asciidoc
:front-cover-image: image:desktop-cover.jpg[Front Cover,750,1200]
:toc: left
:toc-title: Contents
:toclevels: 0
...
include::{includes}/ch-00-preface.adoc[]
include::{includes}/ch-00-notes-on-the-second-edition.adoc[]
