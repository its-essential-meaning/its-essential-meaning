...
field, Consciousness is the seed.”^AN{nbsp}3.76^ Just as the seed springs up out of
the field the new position becomes present (Consciousness) resulting
from the intentional action (__kamma__).

// Above: https://suttacentral.net/pi/an3.76
...
// FIXME: reference below for Saṃyutta Nikāya 11. Abhisamaya Saṃyutta, Gahepati Vagga, Dukkha Sutta
...
Perception)”^DN{nbsp}9^ But the case with Name-and-Form
