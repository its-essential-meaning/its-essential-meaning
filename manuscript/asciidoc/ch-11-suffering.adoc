...
Suffering, of much tribulation, wherein is more peril.’ (https://suttacentral.net/mn22/en/bodhi[MN 22])
...
abhinandati__ (https://suttacentral.net/mn1/en/bodhi[MN 1]). He delights in ‘self’-existence. He does
...
ceases.’ (https://suttacentral.net/sn5.10/en/bodhi[SN 5.10])
...
feeling, bodily and mental.’ (https://suttacentral.net/sn36.6/en/bodhi[SN 36.6])
...
‘For the monk who hath all _kamma_ left behind, +
