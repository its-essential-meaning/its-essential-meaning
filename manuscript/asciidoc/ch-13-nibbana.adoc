...
(__methunaṁ dhammaṁ__). The monk is whom the taints are destroyed is
...
pass:[<br/><br/>]
'Voice from beyond' (__Parato ghoso__) refers to the voice of an Arahat, the 'beyond' referring to Arahatship. See <<ch-13-nibbana.adoc#beyond,"Pāraṁ -- The Beyond...">>]
