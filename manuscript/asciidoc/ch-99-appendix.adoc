...
In the _Sangīti Sutta_ ([https://suttacentral.net/dn33[DN 33]]) are given three groupings of
...
Unfortunately, he knows no _escape_ from the _sakkāya_. He does not know
...
find a way out. In this attempt he gets very close to the view of _no existence_.
...
duality of _is_ and _is not_ -- a duality which in extremist thinking points
...
Suffering. Let alone _experiencing_ the cessation of Suffering it does not
give one any opportunity whatsoever to even _see_ the cessation of
...
considering that _same_ thing as 'not mine' but by switching his mind over
to considering some _other_ thing as 'mine'. Considering this other thing
...
things as 'mine'. Whether it is _this_ that he is considering as 'mine' or
whether it is _that_, it hardly matters. What matters is that the
...
same as 'for me' (in fact the Pali word _me_ refers to both 'mine' and
'for me'), we also have 'for me' points to 'I am'. The _puthujjana_ sees
these things the other way about.

== IX. Upādisesa

_Upādisesa_ means _residue_, or _that which is remaining_.
...
instance, in the _Satipatthāna Sutta_ ([https://suttacentral.net/mn10[MN 10]]) it is used to
...
are by no means the same. Thus, the word _upādisesa_ does not specify _what_
remains. For this reason Ñāṇavīra Thera considers that _upādisesa_ must be
_unspecified_ residue.
...
has meaning _only_ from the fact of the Mode being grasped (_upādinnaṁ_).
...
the sense of considering sympathy as 'mine'. There is no '__my__ sympathy'
or '__I am__ in sympathy' with the Arahat. In the phrase _anukampaṁ upādāya_
...
in _pañcupādānakkhandha_ is the _Aggivacchagotta Sutta_ ([https://suttacentral.net/mn72[MN 72]]).
...
_me_ after death if _I_ become Arahat?' It is an answer to _this_ question
...
_he_ as a subject _is_ involved. _He_ wants to know what will happen to _him_
after death if _he_ becomes Arahat. Since the questioner is a _puthujjana_
the question appears valid _to him_, and so he keeps on asking it. Not
...
and so he keeps on asking them. At the same time he sees that _no_ answer
to any one of them is justifiable. He can proceed no further, and so his
thinking ends in frustration.

The Buddha also does not answer these questions. But he shows _how_ and
_why_ they arise. When this is seen the invalidity of the questions is
...
answering unanswerable questions, but by bringing him to the _cessation_
...
ln the _Sabbāsava Sutta_ ([https://suttacentral.net/mn2[MN 2]]), it is said that adherence to
rites and ritual, doubt, and 'person'-view are to be laid aside by _seeing_ (__dassana__).

This means, that one has to _see_ that adherence to rites and ritual,
doubt (about the Dhamma), and having 'person'-view prevent the cessation
of Suffering. This _seeing_ is not quite as easy and simple as it would
...
depths of one's own personal existence, can bring about this _seeing_.
...
It should be noted that the Suttas do not explain _how_ rebirth takes
place. They only tell us that so long as a being dies with Ignorance and
_taṇhā_ there is a new _bhavā_ springing up.

Conceptually thinking out _how_ rebirth takes place (the mechanics of it,
...
e.g. _by going beyond the Suttas_ and introducing the concept of a _paṭisandhi viññāna_).

What one _has_ to do, as the Buddha says, is to see
...
him cannot be in an unfortunate sphere; and that, _for him_, is the most
...
about rebirth (which are purely speculative unless one _sees_ rebirth)
