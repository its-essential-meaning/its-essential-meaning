...
In the _Kukkuravatika Sutta_ (https://suttacentral.net/mn57/en/bodhi[MN 57]) and else where we
...
this applies to the use of the triad in the _Kukkuravatika Sutta_ too.
...
instance, in the _Satipaṭṭhāna Sutta_ (https://suttacentral.net/mn10/en/sujato[MN 10]) it is used to
...
The Buddha said that the Dhamma is well said __(svākkhāto)__ and leading on
