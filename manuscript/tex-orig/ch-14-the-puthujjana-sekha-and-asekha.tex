...
In the \emph{Saṁyutta Nikāya} we have the difference between the \emph{sekha}
...
The \emph{puthujjana} is \textbf{not} on the Path to \emph{Nibbāna}, whilst the \emph{sekha}
