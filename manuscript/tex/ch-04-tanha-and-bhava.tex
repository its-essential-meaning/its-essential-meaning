...
If \emph{bhava} means `existence' pure and simple, then the living Arahat cannot have completely destroyed \emph{bhava}, for as a living Arahat there is an `existence'.\footnote{See \href{ch-08-impermanence.xml\#living-experience}{Chapter 8, Impermanence}: `The Not-Determined therefore is the \authoremph{living experience of the Arahat}.'} The living Arahat has `existence', but no \emph{bhava}. He is \emph{bhava}-ceased. \emph{Bhava} refers to the existence of \authoremph{all} modes of life \authoremph{other than} that of the Arahats, simply because all such modes of life, save the Arahat's, are a case of `\authoremph{my} existence' or `self'-existence to some degree or other.
