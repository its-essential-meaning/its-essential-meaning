...
But why say `\authoremph{person}'-view \emph{(sakkāyadiṭṭhi)}?
...
It is of great \authoremph{practical} importance to see that `mine' is the most fundamental of these three notions `mine', `I' and `self'. The \emph{puthujjana}'s constant thinking is a thinking that something is \authoremph{his}. In fact there is nothing more fundamental than this about his experience. And he must seek to understand this state of affairs in his own experience itself. The notions `I' and `self' do not take the same stature as the notion `mine'. When he, the \emph{puthujjana}, is conscious of a feeling, he is always conscious of it as \authoremph{my} feeling. It is this consideration `mine' that leads the \emph{puthujjana} on.

\enlargethispage{\baselineskip}

The \emph{puthujjana}, however, works with the assumption that the fundamental is `I' and not `mine'. Since \authoremph{he} exists, he thinks things are \authoremph{his}. `\authoremph{Since ``I''} exist, things are \authoremph{mine}.'

But the fundamental condition, the Buddha points out, is `mine'. The \emph{puthujjana} having Grasping Consciousness, things \authoremph{present} themselves to him as \authoremph{`mine'}. And this state of affairs further \authoremph{points} to a subject to \authoremph{whom} they are present. That is, they point to an `I'. The correct position is therefore: \authoremph{Since things are `mine', `I' exist.}

The \emph{puthujjana} then begins to wonder what precisely this `I' is. He begins to reflect upon the `I'. And when he so reflects he sees a `self'; that is to say, he sees a mastery over things. A `self' appears before him as he reflects, just as `water' appears to the deer when it gazes upon the sun shining on the sand. `Mine' being present all the time, this `self' also appears as `\authoremph{my} self'.
