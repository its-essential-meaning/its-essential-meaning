...
Of the three notions `This is mine, this am I, this is my self', the most fundamental one is `\authoremph{this is mine}'. In the Discourse on \emph{The Fundamentals of All Things} (Majjhima Nikāya 1) the Buddha narrates at length the many things that the \emph{puthujjana} takes to be `mine'. He does \authoremph{not} include the other two notions of `I' and `self' at all in this Discourse.
