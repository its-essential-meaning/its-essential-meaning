...
That Ignorance depends upon Ignorance really means this: any thing upon which Ignorance depends \authoremph{involves} Ignorance. The Five Grasping Groups is a matter of \authoremph{not-knowing} things rightly. Thus all factors that make for the \authoremph{Grasping} Groups are \mbox{individually} also a matter of \authoremph{not-knowing} rightly. Ignorance is something negative and abstract -- \authoremph{not-knowing}. Its corresponding direct positive manifestation is the Grasping, which essentially is a considering things as `mine'.
